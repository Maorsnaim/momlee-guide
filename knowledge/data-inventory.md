...
| Identity verification status | Sensitive Info | Trust — all users verified | `verification_application` (status + reason + attempts ONLY) | Yes | No | **Didit** (processor — holds the raw ID scan/selfie; we never receive them; **6-month retention at Didit**, Sivan 2026-08-12) | **Canonical inventory lives in Notion** (single source of truth, Sivan 2026-08-12): [identity_verification_data — Privacy Notes / Data Inventory](https://app.notion.com/p/38e450ad0ae68169ad82d961f61a6ecb). Owner-read; written by signed webhooks only |
